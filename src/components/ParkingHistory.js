...
//     (booking) => filter === 'all' || determineBookingStatus(booking) === filter
//   );
...
//                 >
//                   <div className="booking-basic-info">
//                     <h3>{booking.parkingLotName || 'Unknown Parking Lot'}</h3>
//                     <div className="booking-meta">
//                       <span className="booking-id">ID: {booking.bookingId || booking.id}</span>
//                       <span className={`booking-status ${getStatusClass(displayStatus)}`}>
//                         {displayStatus.charAt(0).toUpperCase() + displayStatus.slice(1)}
//                       </span>
//                     </div>
...
//                       <div className="payment-info">
//                         <h4>Payment Details</h4>
//                         <div className="payment-amount">₹{booking.amount || 'N/A'}</div>
//                       </div>
//                       <div className="payment-method">
//                         {booking.paymentMethod === 'card' ? 'Card Payment' : 'Online Payment'}
//                       </div>
